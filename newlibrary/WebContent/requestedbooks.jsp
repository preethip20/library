...
String sql ="SELECT b.bookid,b.bookname,b.description,b.author,b.price,b.publisher,r.userid FROM book b inner join book_request r on b.bookid=r.bookid where r.userid=?";
...
%><tbody></tbody>
					...
					<a class="btn btn-primary" style="margin-top:20px;margin-left:70px;padding:20px 50px" href="userlogin.jsp?userid=<%=id%>">GO TO HOMEPAGE</a>
					<a class="btn btn-primary" style="margin-top:20px;margin-left:120px;padding:20px 50px" href="requestedbookstatus.jsp?userid=<%=id%>">BOOK STATUS</a>
					<a class="btn btn-primary" style="margin-top:20px;margin-left:170px;padding:20px 50px" href="request.jsp?userid=<%=id%>">REQUEST BOOKS</a>
					</form>
				</div>
			</div>
		</div>
