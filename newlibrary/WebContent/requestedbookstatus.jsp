...
%>	
	<div class="limiter">
			...
			<div class="wrap-table100">
				<h1 style="text-align:center">Status of Requested Books</h1>	
				<hr>
				<div class="table100">
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column1">Book Status</th>
...
String sql ="SELECT bookid,bookname,bookstatus,statusdate,updatedby from bookstatus where userid=?";
...
%>
						<tbody>
								...
								<%--<input type="hidden" name="bookid" value=<%=resultSet.getString("bookid") %>> --%>
									...
									<td class="column1"><%=resultSet.getString("bookstatus") %></td>
									<td class="column1"><%=resultSet.getString("statusdate") %></td>
									<td class="column1"><%=resultSet.getString("updatedby") %></td>
								</tr>
